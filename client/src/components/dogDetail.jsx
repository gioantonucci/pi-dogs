            ...
            
            {
                ...
                <div className={s.card}>
                    ...
                    "https://pm1.narvii.com/6893/724dede9a107e0d420269799b4efe8be26a88df9r1-842-1024v2_00.jpg"}/>
                     ...
                     {!myDog[0].life_time_max? `Their life span is approximately ${myDog[0].life_time_min}.` : `Their life span is between ${myDog[0].life_time_min} and ${myDog[0].life_time_max} years.`} <br/>
                    
                    
                    Their temperaments are {!myDog[0].userCreated? myDog[0].temperament + ' ' : myDog[0].temperaments.map(el => el.name + (', '))}. <br/>
                    

                    {!myDog[0].height_max? `These dogs can measure up to ${myDog[0].height_min} cm approximately` : `These dogs can measure between ${myDog[0].height_min} and ${myDog[0].height_max} cm.`} <br/>
