...
import { getDogs, orderByName, filterCreated, orderByWeight, getTemperaments, filterTemperament } from "../actions";
        ...
        <div>
            <div>
                ...
                <select onChange={e=> handleFilterByTemperament(e)}>
                    <option value='' disabled selected>Filtrar por temperamento:</option>
